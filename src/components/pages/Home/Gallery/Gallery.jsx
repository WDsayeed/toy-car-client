  ...
  return (
    <div className="md:container mx-auto my-36">
      ...
      <div className="grid md:grid-cols-3 gap-10 mt-14">
        <div className="w-[450px] overflow-hidden relative transition duration-200 transform hover:-translate-y-1" data-aos="fade-down-right">
        ...
        <div className="w-[450px] overflow-hidden relative transition duration-200 transform hover:-translate-y-1" data-aos="fade-left">
        ...
        <div className="w-[450px] overflow-hidden relative transition duration-200 transform hover:-translate-y-1" data-aos="fade-up-right">
